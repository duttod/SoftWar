...
@Database(entities = {Entreprise.class, EntreprisePerso.class, Employe.class, Alea.class, ResultatJeu.class,Jeu.class, Pattern.class,EmployeDansEntreprise.class}, version = 1, exportSchema = false)
