...
@Database(entities = {Entreprise.class, EntreprisePerso.class,Logiciel.class, Employe.class, Alea.class, ResultatJeu.class,Jeu.class, Pattern.class}, version = 1, exportSchema = false)
